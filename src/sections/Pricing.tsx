          ...
          {pricingTiers.map((tier) => (
            ...
            >
              <div className="flex justify-between items-center mb-8">
                ...
                {tier.popular && (
                  <div className="inline-flex text-sm px-3 py-1 rounded-xl border border-white/20">
                    <motion.span
                      className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] text-transparent bg-clip-text font-medium"
                      animate={{
              ...
              <div className="mb-8 flex items-baseline gap-1 mt-[30px]">
                ...
                <span
                  className={tier.inverse ? "text-white/60" : "text-black/60"}
                >
                  /month
                </span>
              </div>
